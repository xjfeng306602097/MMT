package com.makro.mall.gateway.extension.config;

import com.google.code.kaptcha.impl.DefaultKaptcha;
import com.google.code.kaptcha.impl.NoNoise;
import com.google.code.kaptcha.impl.ShadowGimpy;
import com.google.code.kaptcha.util.Config;
import com.makro.mall.gateway.extension.handler.KaptchaTextCreator;
...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getCaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty("kaptcha.textproducer.impl", KaptchaTextCreator.class.getName());
        // 验证码文本字符间距 默认为2
