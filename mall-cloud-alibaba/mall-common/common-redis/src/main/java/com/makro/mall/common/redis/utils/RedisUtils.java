package com.makro.mall.common.redis.utils;
...
@Component
@Slf4j
public class RedisUtils implements RedisConstants {
    ...
    public List<Object> mget(List<String> keys) {
        return CollectionUtil.isNotEmpty(keys) ? redisTemplate.opsForValue().multiGet(keys) : new ArrayList<>();
    }
     ...
     */
    public long removeKeyByScan(String keyPrefix) {
        long total = 0L;
        ...
        total = Optional.ofNullable((Long) redisTemplate.execute(redisScript, Collections.singletonList(keyPrefix + LIKE), SCAN_LIMIT)).orElse(0L);
        return total;
    }
}
